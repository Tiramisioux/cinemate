...
[^overclock]: `cinemate/docs/overclocking.md` — 37.50 / 33.43 fps figures, measured on the two-mode (`6.12.y`-era) driver; `imx585-7modes/imx585.c` applies the ClearHDR HMAX floor to every mode, including the binned entry.
