...
Common issues during a first build, with the quickest fix for each.
...
| **Recording won't start / no storage** | Drive not labelled or formatted as expected | The drive must be formatted **exFAT** and labelled **RAW**, and mounted. See [Quick start](getting-started.md). |
