...
| `ACTIONS`       | `MOUNT`, `TOGGLE MOUNT`, `PREROLL`, `SET RTC` — four buttons                                                                            | One-shot commands with no state: mount storage, mount-or-unmount, run the [storage pre-roll](storage-preroll.md) warm-up clip, copy system time to external RTC.                                                                                                                                                                              |
