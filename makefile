install:
	...
	sudo cp manual_controls_grove_base_hat.service /etc/systemd/system/
	...
	sudo systemctl enable manual_controls_grove_base_hat.service
	...
	sudo systemctl start manual_controls_grove_base_hat.service
...
uninstall:
	...
	sudo systemctl stop manual_controls_grove_base_hat.service
	...
	sudo systemctl disable manual_controls_grove_base_hat.service
	...
	sudo rm /etc/systemd/system/manual_controls_grove_base_hat.service
