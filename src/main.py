...
manual_controls = ManualControls(cinepi_controller, monitor, 
                                 ...
                                 shutter_angle_steps=list(range(1, 360)),       # Define an array for selectable shutter angle values (1-360 degrees)
                                 ...
                                 iso_dec_pin=25,                                # GPIO pin for button for increasing ISO
                                 shu_lock_pin=26,                               # GPIO pin for attaching shutter angle lock switch
                                 fps_lock_pin=18,                               # GPIO pin for attaching fps angle lock switch
