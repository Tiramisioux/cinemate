...
| F-025 | medium | probable | cinemate | correctness | Only text commands are serialised — CLI/serial/HTTP share `_dispatch_lock`, but GPIO, pots, quad rotary and keyboard call controller methods directly with no lock | `cli_commands.py:21,218,257`, `gpio_input.py:53`, `analog_controls.py:128`, `quad_rotary_controller.py:114` |
