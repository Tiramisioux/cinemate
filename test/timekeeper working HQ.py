...
class TimeKeeper:
    def __init__(self, redis_controller, check_interval=0.01, window_size=50, initial_learning_period=100):
        ...
        self.frame_duration_values = [39999.000, 40009.000]
        ...
        self.offset = -0.0048999999999981714  # Initial offset
